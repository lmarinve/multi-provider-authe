...
import sdxLogo from "@/assets/images/sdx-logo.svg?url"; 
        ...
        <div className="text-center space-y-4">
          <div className="flex flex-col items-center space-y-6">
            ...
            <div className="flex items-center justify-center gap-6">
              {/* SDX Logo */}
              <div className="w-12 h-12 bg-white border border-[rgb(120,176,219)] rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
                <img src={sdxLogo} alt="SDX Logo" className="h-8 w-auto object-contain" />
              </div>
